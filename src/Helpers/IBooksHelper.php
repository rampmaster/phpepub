...
class IBooksHelper {
     ...
     */
    public const EPUB3_IBOOK_PREFIX_NAME = "ibooks";
    public const EPUB3_IBOOK_PREFIX_URI = "http://vocabulary.itunes.apple.com/rdf/ibooks/vocabulary-extensions-1.0";

    public const ORIENTATION_NONE = "none";
    public const ORIENTATION_PORTRAIT_ONLY = "portrait-only";
    public const ORIENTATION_LANDSCAPE_ONLY = "landscape-only";
     ...
     * Default: false
     */
    public const EPUB2_FIXED_LAYOUT = "fixed-layout";
     ...
     * Default: false
     */
    public const EPUB2_SPECIFIED_FONTS = "specified-fonts";
     ...
     * Default: false
     */
    public const EPUB2_OPEN_TO_SPREAD = "open-to-spread";
     ...
     * Default: "none"
     */
    public const EPUB2_ORIENTATION_LOCK = "orientation-lock";
     ...
     * Default: false
     */
    public const EPUB2_INTERACTIVE = "interactive";
     ...
     * Default: false
     */
    public const EPUB3_FIXED_LAYOUT = "ibooks:fixed-layout";
     ...
     * Default: "none"
     */
    public const EPUB3_IPHONE_ORIENTATION_LOCK = "ibooks:iphone-orientation-lock";
     ...
     * Default: "none"
     */
    public const EPUB3_IPAD_ORIENTATION_LOCK = "ibooks:ipad-orientation-lock";
     ...
     * Default: false
     */
    public const EPUB3_SPECIFIED_FONTS = "ibooks:specified-fonts";
     ...
     * Default: true
     */
    public const EPUB3_BINDING = "ibooks:binding";
     ...
     */
    public const EPUB3_VERSION = "ibooks:version";
